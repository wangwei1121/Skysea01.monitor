...
public class LoggingEventVO implements ILoggingEvent, Serializable {
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
    	System.out.println("########writeObject1111111111############");
        ...
        System.out.println("########writeObject222222222222222############");
    }

    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
    	System.out.println("########readObject11111############");
        ...
        System.out.println("########readObject2222222############");
    }
